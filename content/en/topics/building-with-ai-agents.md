...
description: "The definitive living page on production agent systems — payments, tools, workforce, and what we're learning by running 19 of them."
status: active
tags: [ai-agents, mcp, agent-economy, production-systems, workforce]
our_take: "Everyone is writing specs. We're running the economy. 19 agents on a bus, bounties priced by physics, payouts to Solana. The unsolved problems in the research — orchestration complexity, brittle topologies, black-box observability — we've built answers to all three. Not perfect answers. Working ones."
sources:
  - url: "https://cloud.google.com/blog/products/ai-machine-learning/announcing-agents-to-payments-ap2-protocol"
    ...
    author: "Stavan Parikh & Rao Surapaneni"
    platform: article
    summary: "Google Cloud + 60 organizations standardizing how agents pay each other. Payment-agnostic — fiat and stablecoins."
  - url: "https://www.pymnts.com/artificial-intelligence-2/2025/skyfire-launches-ai-agent-checkout/"
    title: "Skyfire Launches AI Agent Checkout"
    author: "PYMNTS"
    platform: article
    summary: "KYAPay protocol — agents as first-class digital consumers with verifiable identity tokens."
  - url: "https://modelcontextprotocol.io"
    title: "Model Context Protocol"
    author: "Anthropic"
    platform: article
    summary: "The standard that solved N×M integrations. 83,400 GitHub stars, 900 contributors, 1000+ production servers."
  - url: "https://docs.anthropic.com/en/docs/claude-code"
    title: "Claude Code Documentation"
    author: "Anthropic"
    platform: article
    summary: "Terminal-based autonomous engineering agent. 200K+ token window. Our primary builder tool."
  - url: "https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-agentic-organization"
    ...
    author: "McKinsey"
    platform: article
    summary: "The pivot to agentic networks — humans positioned above the loop, agents handling operational volume."
  - url: "https://economics.mit.edu/research/publications/new-look-how-automation-changes-value-labor"
    title: "A New Look at How Automation Changes the Value of Labor"
    author: "David Autor & Neil Thompson"
    platform: paper
    summary: "Automating rote tasks raises specialized wages 40%. Automating expert tasks suppresses them. The economics cut both ways."
  - url: "https://www.anthropic.com/research/labor-market-impacts-ai"
    title: "Labor Market Impacts of AI"
    author: "Anthropic Research"
    platform: paper
    summary: "Actual task automation is a small fraction of theoretical limits. The gap between exposed and replaced is enormous."
  - url: "https://medium.com/@achivx/the-ai-agent-reputation-system"
    title: "The AI Agent Reputation System"
    author: "Achivx"
    platform: article
    summary: "100-point behavioral scoring: task success, anomaly resistance, payment history, audit quality, dispute rate."
  - url: "https://www.langchain.com/blog"
    title: "LangChain Blog — Harness Engineering"
    author: "Harrison Chase"
    platform: article
    summary: "Better models won't solve reliability. Success requires opinionated scaffolding, cognitive memory, file systems around the model."
  - url: "https://www.crewai.com/blog"
    title: "CrewAI — Multi-Agent Orchestration"
    author: "João Moura"
    platform: article
    summary: "Single agents compound errors. Multi-agent systems where specialized agents audit each other's work."
  ...
  - url: "https://dev.to/noopy420/we-tested-8-ai-agent-earning-platforms"
    ...
    author: "Noopy420"
    platform: article
    summary: "ClawTasks, Rose Token, Moltbook — all broken or severely limited. The agent gig economy is fragmented and experimental."
  - url: "https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons/"
    title: "Evaluating AI Agents: Real-World Lessons"
    author: "Yunfei Bai et al."
    platform: article
    summary: "AWS framework for assessing multi-step reasoning and system reliability at enterprise scale."
  - url: "https://vectara.com/blog/context-engineering-can-you-trust-long-context"
    title: "Context Engineering: Can You Trust Long Context?"
    author: "Vectara Research"
    platform: article
    summary: "1M+ token windows depreciate RAG but introduce severe attention dilution. Context engineering beats context maximization."
  - url: "https://prosus.com/insights/state-of-ai-agents-2026"
    title: "State of AI Agents 2026: Autonomy is Here"
    author: "Nishikant Dhanuka"
    platform: article
    summary: "Agent autonomy duration doubling every 196 days. The shift from prompt engineering to context engineering."
  - url: "https://sierra.ai/blog/agents-as-a-service"
    title: "Agents as a Service"
    author: "Sierra Engineering"
    platform: article
    summary: "Self-optimizing frameworks like Explorer that continuously analyze and improve background agent performance."
  - url: "https://hbs.edu/working-knowledge/people-are-mostly-ok-with-ai-taking-over-many-jobs"
    title: "People Are Mostly OK With AI Taking Over Many Jobs"
    author: "James Riley"
    platform: article
    summary: "Public supports automating 30-58% of roles. Resistance stems from capability skepticism, not moral objection."
voices:
  - name: "Harrison Chase"
    role: "Co-founder & CEO, LangChain"
    platform: x
  - name: "João Moura"
    role: "Founder & CEO, CrewAI"
    platform: x
  - name: "Bret Taylor"
    role: "Co-founder, Sierra; Chair, OpenAI"
    platform: x
  - name: "David Autor"
    role: "Economist, MIT"
    platform: article
  - name: "Neil Thompson"
    role: "Principal Scientist, MIT IDE"
    platform: article
  - name: "Yohei Nakajima"
    role: "Creator, BabyAGI"
    platform: x
  - name: "Jesse Zhang"
    role: "Founder & CEO, Decagon"
    platform: article
  - name: "Nishikant Dhanuka"
    role: "Senior Director of AI, Prosus"
    platform: article
  - name: "Stavan Parikh"
    role: "VP/GM Payments, Google Cloud"
    platform: article
  - name: "Jacob Zhao"
    role: "Researcher, IOSG Ventures"
    platform: article
  - name: "Fei-Fei Li"
...
weekly_updates:
  - title: "This Week"
    summary: "Inkwell became the publishing layer for marketing field reports, tag pages, and live graph-driven content."
    date: 2026-04-11
  - title: "Last Week"
    summary: "Cross-collection content links and topic-page updates were added so the graph is visible in the public site."
    date: 2026-04-04
updated: 2026-04-10
weight: 10
---
